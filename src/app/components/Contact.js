    ...
    <section id="contact" className="page-section" style={{ justifyContent: 'flex-end', alignItems: 'flex-start', minHeight: 'auto' }}>
      <div style={{ textAlign: 'left', marginBottom: '2rem' }}>
        ...
        <div className="contact-links" style={{ marginTop: '2rem' }}>
          ...
          <a href="https://www.linkedin.com/in/elisha.nkunzimana" target="_blank" rel="noopener noreferrer" style={{ display: 'block', marginBottom: '1rem', fontSize: '1.7rem', color: '#fff', textDecoration: 'none', transition: 'all 0.3s ease', opacity: 1 }}>LinkedIn</a>
